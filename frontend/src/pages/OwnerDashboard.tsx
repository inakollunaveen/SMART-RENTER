...
const OwnerDashboard: React.FC = () => {
  ...
  const handleAddListing = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Add property response:", normalized);  // Added debug log
      ...
      if (!newProp) {
        ...
        console.log("New property added:", newProp);  // Added debug log
        console.log("New property photos:", newProp.photos);  // Added debug log
